...
namespace Workslip.Application.Jobs
{
    public interface IJobService
    {
        ...
        Task<Result<IReadOnlyList<JobListItemResponse>>> ListAsync(List<JobStatus>? statuses, string? reportNumber, string? customerName, string? customerEmail, string? customerAddress, int? limit, int? offset, CancellationToken cancellationToken);
