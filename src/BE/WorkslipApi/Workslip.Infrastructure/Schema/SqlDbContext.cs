...
public sealed class SqlDbContext : DbContext
{
    ...
    private static void ConfigureOrganizations(ModelBuilder modelBuilder)
    {
        ...
        entity.ToTable("Organizations", t =>
        {
            t.HasCheckConstraint(
                "CK_Organizations_Cvr_8Digits",
                "Cvr like '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
        });
        entity.HasKey(e => e.Id);
        entity.Property(e => e.Name).HasMaxLength(200).IsRequired();
        entity.Property(e => e.Cvr).HasMaxLength(8).IsRequired();
    ...
    private static void ConfigureUsers(ModelBuilder modelBuilder)
    {
        ...
        entity.Property(e => e.Role).HasMaxLength(80).IsRequired();
        entity.Property(e => e.CreatedAt)
            .HasColumnType("datetimeoffset")
            .HasDefaultValueSql("sysutcdatetime()");
        entity.Property(e => e.UpdatedAt)
    ...
    private static void ConfigureCustomers(ModelBuilder modelBuilder)
    {
        ...
        entity.HasKey(e => e.Id);
        entity.Property(e => e.Name).HasMaxLength(240).IsRequired();
    ...
    private static void ConfigureJobWorkKinds(ModelBuilder modelBuilder)
    {
        ...
        entity.HasKey(e => e.Id);
        entity.Property(e => e.NormalizedLabel).HasMaxLength(80);
        entity.Property(e => e.Label).HasMaxLength(160).IsRequired();
    ...
    private static void ConfigureJobEvents(ModelBuilder modelBuilder)
    {
        ...
        {
            t.HasCheckConstraint(
                "CK_JobEvents_BeforeJson_IsJson",
                "BeforeJson is null or isjson(BeforeJson) = 1");
            t.HasCheckConstraint(
                "CK_JobEvents_AfterJson_IsJson",
    ...
    private static void ConfigureInviteTokens(ModelBuilder modelBuilder)
    {
        ...
        entity.Property(e => e.CreatedAt)
            .HasColumnType("datetimeoffset")
            .HasDefaultValueSql("sysutcdatetime()");
        entity.Property(e => e.OpenedAt).HasColumnType("datetimeoffset");
        entity.Property(e => e.AcceptedAt).HasColumnType("datetimeoffset");
        entity.Property(e => e.EntraUserId).HasMaxLength(80);
        entity.Property(e => e.EntraEmail).HasMaxLength(320);
        entity.Property(e => e.EntraProvisionedAt).HasColumnType("datetimeoffset");
        entity.Property(e => e.EntraCleanedAt).HasColumnType("datetimeoffset");
    ...
    private static void ConfigureWorksheets(ModelBuilder modelBuilder)
    {
        ...
        {
            t.HasCheckConstraint(
                "CK_Worksheets_HoursWorked",
                "HoursWorked >= 0 and HoursWorked <= 24");
            t.HasCheckConstraint(
                "CK_Worksheets_HoursWorked_Increment",
                "(HoursWorked * 4) % 1 = 0");
        });
        entity.HasKey(e => e.Id);
        ...
        entity.HasIndex(e => e.JobId).HasDatabaseName("IX_Worksheets_JobId");
        entity.HasIndex(e => e.UserId).HasDatabaseName("IX_Worksheets_UserId");
        entity.HasIndex(e => e.WorkDate).HasDatabaseName("IX_Worksheets_WorkDate");
    }
    ...
    private static void ConfigureControlCategory(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ControlCategoryRow>(entity =>
        {
            ...
            entity.HasIndex(x => new { x.OrganizationId, x.SortOrder });
        });
    }
    ...
    private static void ConfigureJobReportInstallationCategories(ModelBuilder modelBuilder)
    {
        ...
        entity.HasAlternateKey(x => new { x.OrganizationId, x.Id });
        entity.Property(x => x.SortOrder).HasDefaultValue(0);
        entity.Property(x => x.IsIrrelevant).HasDefaultValue(false);
        ...
        entity.HasIndex(x => new { x.OrganizationId, x.JobReportInstallationId, x.ControlCategoryId })
            .IsUnique();
        entity.HasIndex(x => new { x.OrganizationId, x.JobReportInstallationId, x.SortOrder });
    }
    ...
    private static void ConfigureJobReportInstallationControlPoints(ModelBuilder modelBuilder)
    {
        ...
        entity.Property(x => x.IsChecked).HasDefaultValue(false);

        entity.HasOne(x => x.JobReportInstallationCategory)
            .WithMany(x => x.ControlPoints)
            .HasForeignKey(x => new { x.OrganizationId, x.JobReportInstallationCategoryId })
            .HasPrincipalKey(x => new { x.OrganizationId, x.Id })
            .OnDelete(DeleteBehavior.Cascade);

        entity.HasOne(x => x.ControlPoint)
            .WithMany(x => x.JobReportInstallationControlPoints)
            .HasForeignKey(x => new { x.OrganizationId, x.ControlPointId })
            .HasPrincipalKey(x => new { x.OrganizationId, x.Id })
            .OnDelete(DeleteBehavior.Restrict);

        entity.HasIndex(x => new { x.OrganizationId, x.JobReportInstallationCategoryId, x.SortOrder });
    }
    ...
    private static void ConfigureNotificationQueue(ModelBuilder modelBuilder)
    {
        ...
        entity.HasIndex(e => new { e.Status, e.NextAttemptUtc })
            .HasDatabaseName("IX_NotificationQueue_Status_NextAttempt");
    }
    ...
    private static void ConfigureIdempotencyRecords(ModelBuilder modelBuilder)
    {
        ...
        entity.HasIndex(x => new { x.Scope, x.Key })
            .IsUnique()
            .HasDatabaseName("UX_IdempotencyRecords_Scope_Key");
