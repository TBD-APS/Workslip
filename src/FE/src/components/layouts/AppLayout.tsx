    ...
    <AppScrollRestoreBoundary restoreKey={restoreScrollKey}>
      <DropdownProvider>
        <div ref={scrollContainerRef} className="app-shell">
          ...
          <nav className="desktop-primary-nav" aria-label="Primær navigation">
            <div className="desktop-primary-nav__inner">
              <NavLink
                to={appHomePath}
                end
                className={({ isActive }) => `desktop-nav-item ${isActive ? 'active' : ''}`}
                onClick={() => scrollToTopIfActive(appHomePath)}
              >
              ...
              <Can permission="worksheet:view">
                <NavLink
                  to="/app/timer"
                  className={({ isActive }) => `desktop-nav-item ${isActive ? 'active' : ''}`}
                  onClick={() => scrollToTopIfActive('/app/timer')}
                >
              ...
              <Can permission="user:manage">
                <NavLink
                  to="/app/users"
                  className={({ isActive }) => `desktop-nav-item ${isActive ? 'active' : ''}`}
                  onClick={() => scrollToTopIfActive('/app/users')}
                >
                  <Users size={18} />
                  <span>Folk</span>
                </NavLink>
              ...
              <Can permission="customer:view">
                <NavLink
                  to="/app/customers"
                  className={({ isActive }) => `desktop-nav-item ${isActive ? 'active' : ''}`}
                  onClick={() => scrollToTopIfActive('/app/customers')}
                >
                  <Building2 size={18} />
                  <span>Kunder</span>
                </NavLink>
              ...
              <button
                type="button"
                className={`desktop-nav-item desktop-nav-search ${quickNavigatorOpen ? 'active' : ''}`}
                onClick={() => setQuickNavigatorOpen(true)}
                aria-haspopup="dialog"
                aria-expanded={quickNavigatorOpen}
              >
          ...
          <nav className="bottom-nav" aria-label="Primær mobilnavigation">
