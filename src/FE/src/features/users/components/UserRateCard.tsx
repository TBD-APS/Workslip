...
const rateKey = (userId: string) => ['/api/users', userId, 'billing-rate'] as const;
    ...
    <div className="section-card">
      ...
      {query.isLoading ? (
        ...
        <div className="form-group">
          ...
          <NumericInput id="user-hourly-rate" value={value} kind="decimal" min={0} max={100000} onChange={setValue} disabled={mutation.isPending} />
