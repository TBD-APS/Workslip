    ...
    <div className="page-container overview-page">
      <div className="page-header overview-header">
        ...
        <button
          ...
          onClick={() => navigate(getStatusListPath(JobStatus.Rejected))}
        >
      ...
      <section className="overview-status-grid" aria-label="Sagsstatus">
        {statusCards.map((card) => (
          <button
            ...
            onClick={() => navigate(getStatusListPath(card.status))}
          >
      ...
      <section className="overview-recent-card" aria-labelledby="recent-jobs-heading">
        ...
        {overviewQuery.isPending ? (
          ...
          <div className="overview-empty-state">
            ...
            <button type="button" className="btn btn-secondary" onClick={() => navigate(getStatusListPath(JobStatus.Draft))}>
              Gå til aktive sager
            </button>
          </div>
        )}
