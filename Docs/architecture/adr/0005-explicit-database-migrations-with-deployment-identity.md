# ADR 0005: Explicit database migrations use a deployment-only identity
...
- Release validation checks migration filenames and transaction/batch constraints before a release is eligible for production.
...
- Web API compromise no longer automatically carries schema-management rights.
