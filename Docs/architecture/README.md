...
- [`adr/0017-public-enrollment-pre-tenant-trust-model.md`](adr/0017-public-enrollment-pre-tenant-trust-model.md) — Workslip 6.1 public enrollment trust boundary: Microsoft-only provider, explicit pre-tenant state, immutable external identity mapping, `Organization.Id` tenant identity and CVR/legal metadata separation.
