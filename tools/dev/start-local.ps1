...
try {
    ...
    Write-Step 'Starting frontend without rebuilding the backend contract'
    $frontendArguments = '/d /s /c ""{0}" run dev:server"' -f $npmCommand
    $frontendProcess = Start-Process $env:ComSpec `
