  ...
  <div class="container hero-grid">
    <div>
      ...
      <div class="actions">
        ...
        <a class="button secondary" href="https://app.workslip.dk/app">Åbn Workslip</a>
      </div>
    </div>
    <div class="card">
      <h2>Fra opgave til godkendelse</h2>
      <p>Registrér arbejdet på mobilen, følg status og få et samlet grundlag til administration og fakturering.</p>
    </div>
  </div>
</section>
